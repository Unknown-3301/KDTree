...
public class ColoredPoint : IKDShape
{
    ...
    public GPUColoredPointData Convert() => new GPUColoredPointData() { Position = Position, Color = Color };

    public void ResetColor() => Color = InitColor;
}
